...
``` 
my_model <- MCMmodel(data_summary, kernel = "contemporaneous")
```
...
``` 
my_model <- MCMmodel(data_summary, n_latent=2, kernel = "contemporaneous")
```
...
```
my_model <- MCMmodel(data_summary, n_latent=2, causal_latent=TRUE,
                     causal_observed=FALSE, kernel = "contemporaneous")
```
...
my_model <- MCMmodel(data_summary, n_latent=2,
                     latent_names=c("positive_affect", "negative_affect"),
                     kernel = "contemporaneous")
```
